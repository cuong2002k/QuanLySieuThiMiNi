namespace QuanLySieuThiMini.UI
{
	partial class UCTraHang
	{
		...
		private void InitializeComponent()
		{
			...
			this.grDsTrahang = new DevExpress.XtraGrid.GridControl();
			this.gvDstrahang = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			((System.ComponentModel.ISupportInitialize)(this.grDsTrahang)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gvDstrahang)).BeginInit();
			...
			this.layoutControl1.Size = new System.Drawing.Size(685, 409);
			this.layoutControl1.TabIndex = 0;
			this.layoutControl1.Text = "layoutControl1";
			// 
			// groupControl2
			// 
			this.groupControl2.Controls.Add(this.grDsTrahang);
			this.groupControl2.Location = new System.Drawing.Point(344, 38);
			this.groupControl2.Name = "groupControl2";
			this.groupControl2.Size = new System.Drawing.Size(329, 358);
			this.groupControl2.TabIndex = 9;
			this.groupControl2.Text = "Danh Sách Hàng Hóa Xuất";
			// 
			// grDsTrahang
			// 
			this.grDsTrahang.Dock = System.Windows.Forms.DockStyle.Fill;
			this.grDsTrahang.Location = new System.Drawing.Point(2, 23);
			this.grDsTrahang.MainView = this.gvDstrahang;
			this.grDsTrahang.Name = "grDsTrahang";
			this.grDsTrahang.Size = new System.Drawing.Size(325, 333);
			this.grDsTrahang.TabIndex = 0;
			this.grDsTrahang.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gvDstrahang});
			// 
			// gvDstrahang
			// 
			this.gvDstrahang.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.gridColumn13,
            this.gridColumn14,
            this.gridColumn15,
            this.gridColumn16});
			this.gvDstrahang.GridControl = this.grDsTrahang;
			this.gvDstrahang.Name = "gvDstrahang";
			// 
			// gridColumn13
			// 
			this.gridColumn13.Caption = "MaHH";
			this.gridColumn13.FieldName = "MaHH";
			...
			// gridColumn14
			// 
			this.gridColumn14.Caption = "TenHH";
			...
			// gridColumn15
			// 
			this.gridColumn15.Caption = "SoLuongTra";
			this.gridColumn15.FieldName = "SoLuongTra";
			...
			// gridColumn16
			// 
			this.gridColumn16.Caption = "Lydotrahang";
			this.gridColumn16.FieldName = "Lydotra";
			...
			// groupControl1
			// 
			this.groupControl1.Controls.Add(this.grcontrol);
			this.groupControl1.Location = new System.Drawing.Point(12, 38);
			this.groupControl1.Name = "groupControl1";
			this.groupControl1.Size = new System.Drawing.Size(328, 359);
			...
			this.grcontrol.Location = new System.Drawing.Point(2, 23);
			this.grcontrol.MainView = this.dvDSHangHoa;
			this.grcontrol.Name = "grcontrol";
			this.grcontrol.Size = new System.Drawing.Size(324, 334);
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(685, 409);
			...
			this.layoutControlItem1.Size = new System.Drawing.Size(332, 363);
			...
			this.layoutControlItem2.Location = new System.Drawing.Point(332, 26);
			this.layoutControlItem2.Name = "layoutControlItem2";
			this.layoutControlItem2.Size = new System.Drawing.Size(333, 362);
			...
			this.simpleSeparator1.Location = new System.Drawing.Point(332, 388);
			...
			// gridColumn3
			// 
			this.gridColumn3.Caption = "MaHH";
			this.gridColumn3.FieldName = "MaHH";
			...
			// gridColumn4
			// 
			this.gridColumn4.Caption = "TenHH";
			...
			// gridColumn8
			// 
			this.gridColumn8.Caption = "SoLuongTra";
			this.gridColumn8.FieldName = "SoLuongTra";
			...
			// gridColumn10
			// 
			this.gridColumn10.Caption = "Lydotrahang";
			this.gridColumn10.FieldName = "lydotrahang";
			...
			((System.ComponentModel.ISupportInitialize)(this.grDsTrahang)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gvDstrahang)).EndInit();
		...
		private DevExpress.XtraGrid.GridControl grDsTrahang;
		private DevExpress.XtraGrid.Views.Grid.GridView gvDstrahang;
